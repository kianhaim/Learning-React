...
const updateNumberArray = insertAtBeginning(numberArray, -1); // -1, 1, 2, 3, 4, 5
const updateStringArray = insertAtBeginning(stringArray, "a"); // a, a, b, c

// Typescript knows that its a number / Split does not work with numbers
//updateNumberArray[0].split("");
// Typecript knows its a string so split method works
updateStringArray[0].split("");
